...
question_cache_mgr = CacheManager('question_cache.json', lambda: question_cache)
...
def save_question_cache():
    question_cache_mgr.save()

def load_question_cache():
    question_cache.update(question_cache_mgr.load())
